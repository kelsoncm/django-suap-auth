#!/usr/bin/env python
"""
Script para testar a configuração do SUAP no sandbox Django 6.0
"""
import os
import sys
import django
...
print("=" * 80)
print("TESTE DE CONFIGURAÇÃO SUAP - DJANGO 6.0 SANDBOX")
print("=" * 80)
...
print(f"   SUAP_AUTH_DIRECT_REDIRECT: {os.environ.get('SUAP_AUTH_DIRECT_REDIRECT', 'NÃO DEFINIDO')}")

print("\n2. Configurações Django:")
print(f"   SUAP_CLIENT_ID: {settings.SUAP_CLIENT_ID}")
print(f"   SUAP_CLIENT_SECRET: {settings.SUAP_CLIENT_SECRET[:20]}...")
print(f"   SUAP_REDIRECT_URI: {settings.SUAP_REDIRECT_URI}")
